...
public class MessageUtil {
    ...
    public static void send(String phone,String content){
        ...
        // content = new String("【监考拍卖系统】----"+"您的验证码是：" + mobile_code + "。请不要把验证码泄露给其他人。");

        NameValuePair[] data = {//提交短信
                new NameValuePair("account", "C55669048"),
                new NameValuePair("password", "bc0ee6731616a36c3930cff97de0bd0a"), //查看密码请登录用户中心->验证码、通知短信->帐户及签名设置->APIKEY
    ...
    public static void aliMsg(String telephone, JSONObject params,String template){
        TaobaoClient client = new DefaultTaobaoClient("http://gw.api.taobao.com/router/rest",
                "23819392", "8dfed11e33c0a78caaf622b128bb0094");
        AlibabaAliqinFcSmsNumSendRequest req = new AlibabaAliqinFcSmsNumSendRequest();
        req.setExtend( "" );
        req.setSmsType( "normal" );
        req.setSmsFreeSignName( "监考拍卖系统" );
        req.setSmsParamString( params.toJSONString() );
